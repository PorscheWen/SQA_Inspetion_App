...
echo   • 詳細疑難排解請查看 WINDOWS_疑難排解.md
echo.
...
set "INSPECTOR_BAT=%PROJECT_ROOT%\Automation_testcase\Project_FlaUIBDD\Testcase_Inspection_App_FlaUI_BDD\開啟Inspector.bat"
