...
public static class HtmlReportHelper
{
    ...
    public static void InitializeReport(string reportDirectory = "reports", string reportName = "Inspection_AppTestReport.html")
    {
        lock (Lock)
        {
            if (_extent != null)
            ...
            htmlReporter.Config.ReportName = "Inspection App 自動化測試報告";
            htmlReporter.Config.Encoding = "UTF-8";

            _extent = new ExtentReports();
            _extent.AttachReporter(htmlReporter);
            _extent.AddSystemInfo("專案", "Inspection App");
